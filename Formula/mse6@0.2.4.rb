class Mse6AT024 < Formula
  desc "HTTP/1.1 server implementing mock responses for testing of edge cases"
  homepage "https://github.com/simonmittag/mse6"
  url "https://github.com/simonmittag/mse6/archive/v0.2.4.tar.gz"
  sha256 "b0f7b06add448ef7dc707ec0b05f01d89156b80df35211b25bac71a038edc4e9"
