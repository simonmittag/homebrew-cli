class Mse6AT043 < Formula
  desc "HTTP/1.1 server implementing mock responses for testing of edge cases"
  homepage "https://github.com/simonmittag/mse6"
  url "https://github.com/simonmittag/mse6/archive/v0.4.3.tar.gz"
  sha256 "c2d30ebf4ddacf51d839b5415ba4465188707bda08bfbcd0c0c31398a8a8a247"
